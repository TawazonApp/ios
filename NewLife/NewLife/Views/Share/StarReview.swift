...
public class SwiftyStarRatingView: UIControl {
    ...
    @IBInspectable public var allowsHalfStars: Bool = false
    @IBInspectable public var accurateHalfStars: Bool = false
    ...
    override public func draw(_ rect: CGRect) {
        ...
        for idx in 0..<Int(_maximumValue) {
            ...
            let newIdx = (Int(_maximumValue) - 1) - idx
            let highlighted = Float(newIdx+1) <= ceilf(Float(_value))
...
extension SwiftyStarRatingView {
    ...
    fileprivate func handle(touch: UITouch) {
        ...
        self.value = maximumValue - aValue + 1
    }
}
