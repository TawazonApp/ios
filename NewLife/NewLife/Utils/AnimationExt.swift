...
//
//http://aashishdhawan.github.io/technical/media-timing-function/
//https://gist.github.com/nuthinking/7415509
import Foundation
import UIKit

extension UIView {
    
    class func animate(WithDuration duration: TimeInterval, timing: CAMediaTimingFunction, animations: @escaping () -> Void,  completion: ((Bool) -> Void)? = nil) {
        
        CATransaction.begin()
        CATransaction.setAnimationTimingFunction(CAMediaTimingFunction.easeOutQuart)
