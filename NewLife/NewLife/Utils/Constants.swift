...
struct Api {
   ...
   //Membership
    ...
    static let subCategorySessionsListUrlV2_3 = "\(apiUrlV2_3)/sessions/list/{id}"
    static let subCategorySectionSessionsListUrl = "\(apiUrlV2)/meditations/list/{categoryID}"
    static let sessionsDownloadListUrlV2_3 = "\(apiUrlV2_3)/sessions/downloads/list"
    static let sessionsFavoriteListUrl = "\(apiUrlV2)/user/favourites/list"
    static let sessionsFavoriteListUrlV2_3 = "\(apiUrlV2_3)/user/favourites/list"
    static let addSessionToDownloadUrlV2_3 = "\(apiUrlV2_3)/sessions/downloads/add/{id}"
    static let removeSessionToDownloadUrlV2_3 = "\(apiUrlV2_3)/sessions/downloads/remove/{id}"
